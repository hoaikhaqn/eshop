                                    ...
                                    <div className="payment-methods">
                                        ...
                                        <div className="payment-method">
                                            <div className="custom-control custom-radio">
                                                ...
                                                <label className="custom-control-label" htmlFor="payment-1">Paypal</label>
                                            </div>
                                        ...
                                        <div className="payment-method">
                                            <div className="custom-control custom-radio">
                                                ...
                                                <label className="custom-control-label" htmlFor="payment-2">Payoneer</label>
                                            </div>
                                        ...
                                        <div className="payment-method">
                                            <div className="custom-control custom-radio">
                                                ...
                                                <label className="custom-control-label" htmlFor="payment-3">Check Payment</label>
                                            </div>
                                        ...
                                        <div className="payment-method">
                                            <div className="custom-control custom-radio">
                                                ...
                                                <label className="custom-control-label" htmlFor="payment-4">Direct Bank Transfer</label>
                                            </div>
